...
- Uses gradient boosting models (XGBoost/LightGBM) for multi-horizon predictions
- Integrates SEC EDGAR filings for fundamental analysis
- Segments predictions by market capitalization for improved accuracy
- Executes automated trades via Alpaca API
- Combines short-term (5-day) and long-term (20-60 day) signals
